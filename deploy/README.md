...
# network mode=bridge, watchtower=true, homepage=false)
...
`ghcr.io/nickbrett1/vikunja-mcp` on every push to
...
(`ghcr.io/nickbrett1/vikunja-mcp:buildcache`) and
...
- **Package visibility** defaults to `public` (so the NAS/Watchtower can pull
  ...
  `org.opencontainers.image.source=https://github.com/nickbrett1/vikunja-mcp`,
